...
var config = require("C:/Users/Andrew Francis/Documents/xray-ImprovedScraper/xray/andrew_config.json"); //See example_config.json
...
function spawnGplayDownloader(args) {
    ...
    console.log("None of these should not be undefined!")
